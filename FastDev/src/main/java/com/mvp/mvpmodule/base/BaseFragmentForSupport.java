 ...
 */
public abstract class BaseFragmentForSupport<P extends IBasePresent> extends Fragment implements RefreshLayoutBaseView{
...
//        }
    ...
    protected void startActivity(Class<?> targetClass, String key, String value,boolean isHasAnim) {
        Intent intent = new Intent(getActivity(), targetClass);
        intent.putExtra(key, value);
        startActivity(intent);
        if(!isHasAnim){
