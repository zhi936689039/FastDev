 ...
 * @version 1.0
 * @package 包名 ：com.renrenda.client.widget
 * @createTime 创建时间 ：2019/7/24
 * @modifyBy 修改人 ：ouyangzhibao
 * @modifyTime 修改时间 ：2019/7/24
 * @modifyMemo 修改备注：
 */
public class CornerTransformHelper implements Transformation<Bitmap> {
    ...
    public CornerTransformHelper(Context context, float radius) {
